...
-   :material-help-rhombus-outline:{ .lg .middle } __Why this approach__
...
-   :material-chart-line:{ .lg .middle } __Proven at scale__
...
-   :material-file-tree-outline:{ .lg .middle } __How it works__
...
-   :material-expansion-card:{ .lg .middle } __Up to 1024 GPUs tested__

    ---
    
    Evaluation included large-scale distributed AI runs across up to 1024 GPUs.

-   :material-speedometer:{ .lg .middle } __Up to 2.47× faster per-node startup__

    ---
    
    Warm-run startup measurements showed substantially faster per-node startup in production-style workflows.

-   :material-chart-box-outline:{ .lg .middle } __Comparable throughput__
